...
const ContactPage = () => {
  return (
    ...
    <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[white] rounded-lg">
    <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
        <div>
            ...
            <p className="text-sm text-black mt-4 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
        ...
        <div className="bg-gray-100 p-6 rounded-lg">
            ...
            <form className="mt-8 space-y-4">
                <input type='text' placeholder='Name'
                    className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[teal" />
                <input type='email' placeholder='Email'
                    className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[teal]" />
                <input type='text' placeholder='Subject'
                    className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[teal]" />
                <textarea placeholder='Message' rows={6}
                    className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[teal]"></textarea>
                <button type='button'
                    className="text-white bg-[teal] hover:bg-[teal tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
